...
class helper {
    ...
    protected static function create(\context $context, $disguisetype) {
        ...
        if ($context->has_disguise()) {
            throw new \moodle_exception('Disguise is already set for this context');
        }
     ...
     */
    public static function add_to_form(\MoodleQuickForm $mform, \stdClass $features, \context $context) {
        global $DB;
